...
//        rightAxis.setAxisMinimum(0f);
     ...
     * @param color
     */
    public void showBarChart(List<Float> xAxisValues, List<Integer> yAxisValues, String label, int color) {
        initLineChart();
...
//    }
     ...
     * @param colours
     */
    public void showBarChart(List<Float> xAxisValues, List<List<Integer>> yAxisValues, List<String> labels, List<Integer> colours) {
        initLineChart();
        BarData data = new BarData();
        ...
        leftAxis.setLabelCount(xAxisValues.size() - 1, false);
//        data.setw(barWidth);
